    ...
    <div class="pl-10">
      <el-form :model="query" inline>
        ...
        <el-form-item size="small">
          <el-button type="primary" @click="getInoutData"><i class="el-icon-search"></i></el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-row :gutter="20">
      <el-col :span="18">
        ...
        <el-table :data="data" show-summary :summary-method="getInoutRecordSummaries" border height="400">
          ...
          <el-table-column label="投入" prop="recordInOut" resizable sortable width="150"></el-table-column>
