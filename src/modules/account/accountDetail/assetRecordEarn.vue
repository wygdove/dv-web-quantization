    ...
    <el-row :gutter="20">
      <el-col :span="12">
        ...
        <el-table :data="data" show-summary :summary-method="getInoutRecordSummaries" border height="400">
          ...
          <el-table-column label="总投入" prop="remark" resizable sortable min-width="100"></el-table-column>
          <el-table-column label="总资产" prop="remark" resizable sortable min-width="100"></el-table-column>
          <el-table-column label="历史盈利" prop="remark" resizable sortable min-width="100"></el-table-column>
          <el-table-column label="持有盈利" prop="remark" resizable sortable min-width="100"></el-table-column>
